...
import 'package:carwash/screens/widgets/oneprocess.dart';
...
class _BodyState extends State<Body> {
  ...
  Widget processWidget(Map<String, dynamic> o) {
    if (prefs.string('appmode') == '3') {
      return OneProcess(o, widget.model);
    }
    return InkWell(
        onTap: () {
                    ...
                    for (final i in o['f_items'] ?? []) ...[
                      Row(
                        children: [
                          ...
                          Expanded(
                              child: Text(
                                  '${i['f_part2name']} ${i['f_dishname']}')),
                          const Icon(Icons.access_alarm_rounded),
                          SizedBox(
                              width: 150,
                              child: Text(
                                  '${dateTimeToTimeStr(o['f_begin'])} - ${dateTimeToTimeStr(o['f_done'])}',
                                  textAlign: TextAlign.right,
                                  style: const TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold,
