...
class Styling {
  ...
  static textColor(String s, double size, bool bold, Color color) {
    return Text(s, style: TextStyle(fontSize: size, fontWeight: bold ? FontWeight.bold : FontWeight.normal, color: color));
  }
}
